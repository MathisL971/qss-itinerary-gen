...
const translations: Record<Language, Translations> = {
  en: {
    labels: {
      ...
      event: "EVENT",
      location: "LOCATION",
      noItemsForDay: "Nothing planned yet",
      ...
      day: "Day",
      noItemsAddedYet: "Nothing planned yet",
  ...
  fr: {
    labels: {
      ...
      feeDetailsAndSpecificPolicies:
        "Détails des frais et politiques spécifiques :",
    ...
    policies: {
      ...
      gypseaPolicy:
        "Les lits de plage ne peuvent pas être pré-confirmés car la priorité est donnée aux clients de l'hôtel. Une note a été ajoutée à votre réservation et l'équipe vous contactera le matin pour reconfirmer. Une fois confirmé, l'arrivée doit avoir lieu entre 10h30 et 12h30. Sinon, les chaises seront libérées.",
      nailsPolicy:
        "Les modifications ou annulations doivent être communiquées au moins 24 heures à l'avance du rendez-vous prévu. Sinon, des frais d'annulation de 100% s'appliqueront.",
      establishments: {
        isola: "ISOLA : Frais de 250€ par personne.",
        shellona:
          "SHELLONA : Frais de 250€ par personne, avec une politique de courtoisie de 30 minutes.",
        tamarin: "TAMARIN : Frais de 150€ par personne.",
        guerite: "LA GUÉRITE : Frais de 250€ par personne.",
        mamo: "MAMO : Frais de 260€ par personne.",
        gypsea:
          "GYPSEA : POLITIQUE D'ANNULATION DE 48 HEURES - Frais de 220€ par personne, avec une politique de courtoisie de 15 minutes.",
      },
    },
    messages: {
      ...
      errorNotFound:
        "Itinéraire partagé introuvable. Le lien peut être invalide ou expiré.",
      errorMissingStay:
        "Itinéraire invalide : informations de séjour manquantes",
      errorUnexpected:
        "Une erreur inattendue s'est produite. Veuillez réessayer plus tard.",
      verifyLink:
        "Veuillez vérifier que vous avez copié le lien complet et réessayer.",
    },
  },
};
